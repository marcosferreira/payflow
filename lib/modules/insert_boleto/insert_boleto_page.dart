...
class _InsertBoletoPageState extends State<InsertBoletoPage> {
  final controller = InsertBoletoControler();

  final monayInputTextController = MoneyMaskedTextController(
    leftSymbol: "R\$",
    decimalSeparator: ',',
  );
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    InputTextWidget(
                      controller: monayInputTextController,
                      validator: (_) => controller
                          .validateValor(monayInputTextController.numberValue),
                      label: 'Valor',
                      icon: FontAwesomeIcons.wallet,
                      onChanged: (value) => controller.onChange(
                          value: monayInputTextController.numberValue),
                    ),
                    InputTextWidget(
